...
/**
 * This class controls the second round of combat with a player that can do more damage.
 * @authors Danny T., Esha S., Ahmad G.
 *
 */

public class RoundBS extends ListenerAdapter {
	
	Player player = new Player(20, 40, 100); //Use same player object from previous classes
	
	Nyx nyx = new Nyx(20, 35, 110);
	
	boolean roundBS = true; 
	
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		
		String[] args = event.getMessage().getContentRaw().split("\\s+");
		
		if (args[0].equalsIgnoreCase("round2s")) {
			...
			Format.formatBattle(round2b, "Battle of the Spirits ⚔️🔮: Type Your Move", "https://media.giphy.com/media/W1SyMKZVBEyIjXqrHr/source.gif", "1bs. Swing your Sword\n" + "2bs. Raise your Shield\n"
								+ "3bs. Throw a Kick\n" + "Your Health: " + player.getCharacterHealthPoints() + "\n" + "Enemy's Health: " + nyx.getHealthPoints(), 0x8a0b00, event);
			...
			if (args[0].equalsIgnoreCase("1bs")) {
				Random r = new Random();
				int min = 0; 
				int max = 4; 
			...
			if (args[0].equalsIgnoreCase("2bs")) {
				int min = 0; 
				int max = 2; 
				...
				Format.formatBattle(nextMove2b, "Battle of the Spirits ⚔️🔮: Type Your Next Move ", "https://media.giphy.com/media/SA6uu0On5CqF9Lyj4x/source.gif", "1bs. Swing your Sword\n" + "2bs. Raise your Shield\n" + "3bs. Throw a Kick\n"
									+ "Your Health: " + player.getCharacterHealthPoints() + "\n" +  "Enemy's Health: " + nyx.getHealthPoints(), 0x8a0b00, event);
			...
			if (args[0].equalsIgnoreCase("3bs")) {
				...
				if (player.getCharacterHealthPoints() == 0 && !event.getAuthor().isBot() && roundBS == true) {
				...
				if (nyx.getHealthPoints() == 0 && !event.getAuthor().isBot() && roundBS == true) {
